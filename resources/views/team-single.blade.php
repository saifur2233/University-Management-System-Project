...
<body class="bg-[#FDFDFC] dark:bg-[#0a0a0a] text-[#1b1b18] min-h-screen">
    ...
    <div class="body_wrap">
        ...
        <main>
            ...
            <section class="breadcrumb bg_img ul_li" data-background="{{ asset('assets/img/bg/breadcrumb_bg.jpg') }}">
                <div class="container">
                    <div class="breadcrumb__content text-center">
                        <h2 class="breadcrumb__title">Instructor details</h2>
                        <p class="breadcrumb__desc">Learn Our Faculty's Expertise and Achievements</p>
                    </div>
                </div>
            </section>
            <!-- breadcrumb end -->
            ...
            <!-- team start -->
            <section class="team-single pt-120 pb-110" data-bg-color="#F1F1E9">
                <div class="container">
                    <div class="team-single__inner">
                        <div class="team-single__info ul_li mb-40">
                            <div class="xb-item--avatar">
                                <img src="{{ asset('assets/img/team/team_single.jpg') }}" alt="">
                            </div>
                            <div class="xb-item--holder">
                                <h3 class="xb-item--name">David Martinez</h3>
                                <ul class="xb-item--list list-unstyled mb-60">
                                    <li><span>Responsibility:</span> Biology Professor</li>
                                    <li><span>Experience:</span> 18 Years</li>
                                    <li><span>Email:</span> david@example.com</li>
                                    <li><span>Phone:</span> +91590 0574 258</li>
                                </ul>
                                <h3 class="team-single__social-title">Social Media</h3>
                                <ul class="xb-social ul_li mt-25">
                        ...
                        <hr class="team-single__hr">
                        <div class="team-single__content mt-90">
                            <h2>Professional Skills</h2>
                            <p>Since joining the Department of Biology in 1993, David Martinez has been instrumental in transforming
                                the program from a group of passionate educators into a leading department recognized for its
                                excellence in Biological Sciences. Under Dr. Matilda's guidance as a Professor of Biology, the
                                department has seen remarkable growth in both research output and student enrollment. This success
                                has been accompanied by the cultivation of a dynamic academic culture that prioritizes student
                                engagement, fosters a spirit of scientific inquiry, and encourages innovation in both teaching and
                                research. David Martinez has been dedicated to mentoring both students and faculty.</p>
                            <h2 class="mt-80">Educational Experience</h2>
                            <p>Armed with a Bachelor's degree in Biology from the University of XYZ, I specialized in molecular
                                biology, genetics, and ecology. To further my expertise, I pursued a Master's in Biological Sciences
                                at ABC University.</p>
                            <div class="team-single__list">
                                <h4>Qualifications:</h4>
                                <ul>
                                    <li>Proficiency in designing and conducting complex biological experiments.</li>
                                    <li>Strong knowledge of molecular techniques, including PCR, gel electrophoresis, and DNA
                                        sequencing.</li>
                                    <li>Experience with ecological fieldwork, data collection, and analysis.</li>
                                    <li>Skilled in using bioinformatics tools for genomic and proteomic data analysis.</li>
                                    <li>Experience in developing and delivering engaging course content for undergraduate and
                                        graduate students.</li>
                                    <li>Excellent research, mentoring, and academic writing skills.</li>
                                </ul>
                            </div>
                        </div>
                    </div>
