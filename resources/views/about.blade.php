    ...
    <div class="body_wrap">
        ...
        <main>
            ...
            <section class="breadcrumb bg_img ul_li" data-background="assets/img/bg/breadcrumb_bg.jpg">
                <div class="container">
                    <div class="breadcrumb__content text-center">
                        ...
                        <p class="breadcrumb__desc">A Public edubost for the Public Good</p>
                    </div>
                </div>
            </section>
            <!-- breadcrumb end -->
            ...
            <section class="about pt-80 pb-120">
                <div class="container">
                    <div class="about-info-inner ul_li_between mt-none-30">
                        ...
                        <div class="about-info mt-30">
                            <h3>CAMPUS</h3>
                            <p>Edubost covers 1,132 acres with 107 buildings, offering 200+ <br> undergraduate majors, plus graduate
                                and online programs.</p>
                        </div>
                    </div>
                    <div class="about-content mt-60">
                        As a public institution, EduFord University is dedicated to fostering positive change through education. We
                        are committed to redefining student success and enhancing our focus on research, creativity, partnerships,
                        and community engagement. To achieve these goals, we must be both efficient and effective. Above all, it is
                        our people—students, faculty, staff, alumni, friends, parents, families, and community members—who drive our
                        university forward and enable us to achieve excellence.
                    </div>
                    <div class="xb-video pos-rel mt-115">
                        <img src="{{ asset('assets/img/bg/video_img.jpg') }}" alt="">
            ...
            <section class="mission-vission z-1 pos-rel pt-110">
                <div class="mission-vission-bg" data-background="{{ asset('assets/img/bg/vm_bg.jpg') }}"></div>
                <div class="container">
                    <div class="row justify-content-center">
                        <div class="col-lg-8">
                            <div class="section-title text-center mb-65">
                                <h2 class="title mb-15">our mission and vision</h2>
                                <p>EduFord University's mission & vision is to empower students with a transformative education that
                                    fosters academic excellence, innovation, and social responsibility. We aim to create an
                                    inclusive environment where students develop critical thinking and prepare for impactful
                                    societal roles.</p>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-none-30">
                        <div class="col-lg-6 mt-30">
                            <div class="mission-vission-item">
                                ...
                                <p class="xb-item--content">EduFord University empowers students through transformative education,
                                    promoting excellence, innovation, and societal impact.</p>
                                <h4 class="xb-item--subtitle">With edubost, you can:</h4>
                                <ul class="xb-item--list list-unstyled">
                                    <li><span><img src="{{ asset('assets/img/icon/check.svg') }}" alt=""></span>Connect with communities through
                                        service.</li>
                                    <li><span><img src="{{ asset('assets/img/icon/check.svg') }}" alt=""></span>Advance through cutting-edge
                                        research.</li>
                                    <li><span><img src="{{ asset('assets/img/icon/check.svg') }}" alt=""></span>Encourage continuous learning and
                                        adaptability.</li>
                                    <li><span><img src="{{ asset('assets/img/icon/check.svg') }}" alt=""></span>Deliver a challenging education.
                                    </li>
                                    <li><span><img src="{{ asset('assets/img/icon/check.svg') }}" alt=""></span>Support critical thinking and
                                        leadership.</li>
                                    <li><span><img src="{{ asset('assets/img/icon/check.svg') }}" alt=""></span>Foster an inclusive, equitable
                                        environment.</li>
                                </ul>
                                <div class="xb-item--shape">
                                    <div class="shape shape--1">
                                        <img src="{{ asset('assets/img/shape/vm_shape1.png') }}" alt="">
                                    </div>
                                    <div class="shape shape--2">
                                        <img src="{{ asset('assets/img/shape/vm_shape2.png') }}" alt="">
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6 mt-30">
                            <div class="mission-vission-item">
                                ...
                                <p class="xb-item--content">EduFord University's vision is to lead globally in education, driving
                                    innovation and preparing students for success in a dynamic.</p>
                                <h4 class="xb-item--subtitle">With edubost, you can:</h4>
                                <ul class="xb-item--list list-unstyled">
                                    <li><span><img src="{{ asset('assets/img/icon/check.svg') }}" alt=""></span>Lead in global education and
                                        research.</li>
                                    <li><span><img src="{{ asset('assets/img/icon/check.svg') }}" alt=""></span>Embrace new teaching methods.</li>
                                    <li><span><img src="{{ asset('assets/img/icon/check.svg') }}" alt=""></span>Champion sustainability efforts.
                                    </li>
                                    <li><span><img src="{{ asset('assets/img/icon/check.svg') }}" alt=""></span>Prepare students for a diverse
                                        world.</li>
                                    <li><span><img src="{{ asset('assets/img/icon/check.svg') }}" alt=""></span>Build strong collaborations.</li>
                                    <li><span><img src="{{ asset('assets/img/icon/check.svg') }}" alt=""></span>Equip students for a changing
                                        world.</li>
                                </ul>
                                <div class="xb-item--shape">
                                    <div class="shape shape--1">
                    ...
                    <div class="row align-items-center mt-none-30">
                        <div class="col-xl-6 col-lg-5 mt-30">
                            <div class="about-image">
                                <img src="{{ asset('assets/img/about/about-img03.jpg') }}" alt="">
                            </div>
                        </div>
                                ...
                                <div class="about-iconbox">
                                    <div class="row mt-none-30">
                                        <div class="col-lg-6 col-md-6 mt-30">
                                            <div class="about-iconbox-item ul_li">
                                                <div class="xb-item--icon">
                                                    <img src="{{ asset('assets/img/icon/ab_01.svg') }}" alt="">
                                                </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 mt-30">
                                            <div class="about-iconbox-item ul_li">
                                                <div class="xb-item--icon">
                                                    <img src="{{ asset('assets/img/icon/ab_02.svg') }}" alt="">
                                                </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 mt-30">
                                            <div class="about-iconbox-item ul_li">
                                                <div class="xb-item--icon">
                                                    <img src="{{ asset('assets/img/icon/ab_03.svg') }}" alt="">
                                                </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 mt-30">
                                            <div class="about-iconbox-item ul_li">
                                                <div class="xb-item--icon">
                                                    <img src="{{ asset('assets/img/icon/ab_04.svg') }}" alt="">
                                                </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 mt-30">
                                            <div class="about-iconbox-item ul_li">
                                                <div class="xb-item--icon">
                                                    <img src="{{ asset('assets/img/icon/ab_05.svg') }}" alt="">
                                                </div>
                                        ...
                                        <div class="col-lg-6 col-md-6 mt-30">
                                            <div class="about-iconbox-item ul_li">
                                                <div class="xb-item--icon">
                                                    <img src="{{ asset('assets/img/icon/ab_06.svg') }}" alt="">
                                                </div>
